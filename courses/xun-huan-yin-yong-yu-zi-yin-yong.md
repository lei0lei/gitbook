...
## [Weak 与循环引用](https://course.rs/advance/circle-self-ref/circle-reference.html#weak-%E4%B8%8E%E5%BE%AA%E7%8E%AF%E5%BC%95%E7%94%A8) <a href="#weak-yu-xun-huan-yin-yong" id="weak-yu-xun-huan-yin-yong"></a>

Rust 的安全性是众所周知的，但是不代表它不会内存泄漏。一个典型的例子就是同时使用 `Rc<T>` 和 `RefCell<T>` 创建循环引用，最终这些引用的计数都无法被归零，因此 `Rc<T>` 拥有的值也不会被释放清理。

### [何为循环引用](https://course.rs/advance/circle-self-ref/circle-reference.html#%E4%BD%95%E4%B8%BA%E5%BE%AA%E7%8E%AF%E5%BC%95%E7%94%A8) <a href="#he-wei-xun-huan-yin-yong" id="he-wei-xun-huan-yin-yong"></a>
...
![](https://pica.zhimg.com/80/v2-0db007dfb4167ebc22f50cf5b5a85f53\_1440w.png)
...
下面一张图很好的展示了这种引用循环关系： ![](https://pic1.zhimg.com/80/v2-2dbfc981f05019bf70bf81c93f956c35\_1440w.png)
...
### [Weak](https://course.rs/advance/circle-self-ref/circle-reference.html#weak) <a href="#weak" id="weak"></a>
...
[**Weak 总结**](https://course.rs/advance/circle-self-ref/circle-reference.html#weak-%E6%80%BB%E7%BB%93)
...
### [使用 Weak 解决循环引用](https://course.rs/advance/circle-self-ref/circle-reference.html#%E4%BD%BF%E7%94%A8-weak-%E8%A7%A3%E5%86%B3%E5%BE%AA%E7%8E%AF%E5%BC%95%E7%94%A8) <a href="#shi-yong-weak-jie-jue-xun-huan-yin-yong" id="shi-yong-weak-jie-jue-xun-huan-yin-yong"></a>

理论知识已经足够，现在用两个例子来模拟下真实场景下可能会遇到的循环引用。

[**工具间的故事**](https://course.rs/advance/circle-self-ref/circle-reference.html#%E5%B7%A5%E5%85%B7%E9%97%B4%E7%9A%84%E6%95%85%E4%BA%8B)
...
[**tree 数据结构**](https://course.rs/advance/circle-self-ref/circle-reference.html#tree-%E6%95%B0%E6%8D%AE%E7%BB%93%E6%9E%84)
...
### [unsafe 解决循环引用](https://course.rs/advance/circle-self-ref/circle-reference.html#unsafe-%E8%A7%A3%E5%86%B3%E5%BE%AA%E7%8E%AF%E5%BC%95%E7%94%A8) <a href="#unsafe-jie-jue-xun-huan-yin-yong" id="unsafe-jie-jue-xun-huan-yin-yong"></a>

除了使用 Rust 标准库提供的这些类型，你还可以使用 `unsafe` 里的裸指针来解决这些棘手的问题，但是由于我们还没有讲解 `unsafe`，因此这里就不进行展开，只附上[源码链接](https://github.com/sunface/rust-algos/blob/fbcdccf3e8178a9039329562c0de0fd01a3372fb/src/unsafe/self-ref.md), 挺长的，需要耐心 o\_o
...
### [总结](https://course.rs/advance/circle-self-ref/circle-reference.html#%E6%80%BB%E7%BB%93) <a href="#zong-jie" id="zong-jie"></a>
...
## [结构体自引用](https://course.rs/advance/circle-self-ref/self-referential.html#%E7%BB%93%E6%9E%84%E4%BD%93%E8%87%AA%E5%BC%95%E7%94%A8) <a href="#jie-gou-ti-zi-yin-yong" id="jie-gou-ti-zi-yin-yong"></a>

结构体自引用在 Rust 中是一个众所周知的难题，而且众说纷纭，也没有一篇文章能把相关的话题讲透，那本文就王婆卖瓜，来试试看能不能讲透这一块儿内容，让读者大大们舒心。

### [平平无奇的自引用](https://course.rs/advance/circle-self-ref/self-referential.html#%E5%B9%B3%E5%B9%B3%E6%97%A0%E5%A5%87%E7%9A%84%E8%87%AA%E5%BC%95%E7%94%A8) <a href="#ping-ping-wu-qi-de-zi-yin-yong" id="ping-ping-wu-qi-de-zi-yin-yong"></a>
...
### [使用 Option](https://course.rs/advance/circle-self-ref/self-referential.html#%E4%BD%BF%E7%94%A8-option) <a href="#shi-yong-option" id="shi-yong-option"></a>
...
### [unsafe 实现](https://course.rs/advance/circle-self-ref/self-referential.html#unsafe-%E5%AE%9E%E7%8E%B0) <a href="#unsafe-shi-xian" id="unsafe-shi-xian"></a>
...
### [无法被移动的 Pin](https://course.rs/advance/circle-self-ref/self-referential.html#%E6%97%A0%E6%B3%95%E8%A2%AB%E7%A7%BB%E5%8A%A8%E7%9A%84-pin) <a href="#wu-fa-bei-yi-dong-de-pin" id="wu-fa-bei-yi-dong-de-pin"></a>
...
### [使用 ouroboros](https://course.rs/advance/circle-self-ref/self-referential.html#%E4%BD%BF%E7%94%A8-ouroboros) <a href="#shi-yong-ouroboros" id="shi-yong-ouroboros"></a>
...
### [Rc + RefCell 或 Arc + Mutex](https://course.rs/advance/circle-self-ref/self-referential.html#rc--refcell-%E6%88%96-arc--mutex) <a href="#rcrefcell-huo-arcmutex" id="rcrefcell-huo-arcmutex"></a>

类似于循环引用的解决方式，自引用也可以用这种组合来解决，但是会导致代码的类型标识到处都是，大大的影响了可读性。

### [终极大法](https://course.rs/advance/circle-self-ref/self-referential.html#%E7%BB%88%E6%9E%81%E5%A4%A7%E6%B3%95) <a href="#zhong-ji-da-fa" id="zhong-ji-da-fa"></a>

如果两个放在一起会报错，那就分开它们。对，终极大法就这么简单，当然思路上的简单不代表实现上的简单，最终结果就是导致代码复杂度的上升。

### [学习一本书：如何实现链表](https://course.rs/advance/circle-self-ref/self-referential.html#%E5%AD%A6%E4%B9%A0%E4%B8%80%E6%9C%AC%E4%B9%A6%E5%A6%82%E4%BD%95%E5%AE%9E%E7%8E%B0%E9%93%BE%E8%A1%A8) <a href="#xue-xi-yi-ben-shu-ru-he-shi-xian-lian-biao" id="xue-xi-yi-ben-shu-ru-he-shi-xian-lian-biao"></a>

最后，推荐一本专门将如何实现链表的书（真是富有 Rust 特色，链表都能复杂到出书了 o\_o），[Learn Rust by writing Entirely Too Many Linked Lists](https://rust-unofficial.github.io/too-many-lists/)

### [总结](https://course.rs/advance/circle-self-ref/self-referential.html#%E6%80%BB%E7%BB%93) <a href="#zong-jie" id="zong-jie"></a>
