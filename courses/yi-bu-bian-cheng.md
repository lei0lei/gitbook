...
![actix-vs-gin screenshot](https://pic1.zhimg.com/v2-3cebd732fb56f43713f106fdcfa44a3c\_b.png)
...
![](https://pic1.zhimg.com/80/v2-de79f3a7a401588d671ecd121916cd90\_1440w.png)
...
<figure><img src="https://pica.zhimg.com/80/v2-eaeb33da283dc1063b862d2307821976_1440w.jpg" alt=""><figcaption></figcaption></figure>
...
### [总结](https://course.rs/advance/async/pin-unpin.html#%E6%80%BB%E7%BB%93) <a href="#zong-jie" id="zong-jie"></a>
...
[**迭代和并发**](https://course.rs/advance/async/async-await.html#%E8%BF%AD%E4%BB%A3%E5%92%8C%E5%B9%B6%E5%8F%91)
...
## [使用 `join!` 和 `select!` 同时运行多个 Future](https://course.rs/advance/async/multi-futures-simultaneous.html#%E4%BD%BF%E7%94%A8-join-%E5%92%8C-select-%E5%90%8C%E6%97%B6%E8%BF%90%E8%A1%8C%E5%A4%9A%E4%B8%AA-future)
...
### [try\_join!](https://course.rs/advance/async/multi-futures-simultaneous.html#try\_join) <a href="#try_join" id="try_join"></a>
...
### [select!](https://course.rs/advance/async/multi-futures-simultaneous.html#select) <a href="#select" id="select"></a>
...
[**default 和 complete**](https://course.rs/advance/async/multi-futures-simultaneous.html#default-%E5%92%8C-complete)
...
### [在 select 循环中并发](https://course.rs/advance/async/multi-futures-simultaneous.html#%E5%9C%A8-select-%E5%BE%AA%E7%8E%AF%E4%B8%AD%E5%B9%B6%E5%8F%91) <a href="#zai-select-xun-huan-zhong-bing-fa" id="zai-select-xun-huan-zhong-bing-fa"></a>
...
## [一些疑难问题的解决办法](https://course.rs/advance/async/pain-points-and-workarounds.html#%E4%B8%80%E4%BA%9B%E7%96%91%E9%9A%BE%E9%97%AE%E9%A2%98%E7%9A%84%E8%A7%A3%E5%86%B3%E5%8A%9E%E6%B3%95)

`async` 在 Rust 依然比较新，疑难杂症少不了，而它们往往还处于活跃开发状态，短时间内无法被解决，因此才有了本文。下面一起来看看这些问题以及相应的临时解决方案。

### [在 async 语句块中使用 ?](https://course.rs/advance/async/pain-points-and-workarounds.html#%E5%9C%A8-async-%E8%AF%AD%E5%8F%A5%E5%9D%97%E4%B8%AD%E4%BD%BF%E7%94%A8-) <a href="#zai-async-yu-ju-kuai-zhong-shi-yong" id="zai-async-yu-ju-kuai-zhong-shi-yong"></a>
...
### [async 函数和 Send 特征](https://course.rs/advance/async/pain-points-and-workarounds.html#async-%E5%87%BD%E6%95%B0%E5%92%8C-send-%E7%89%B9%E5%BE%81) <a href="#async-han-shu-he-send-te-zheng" id="async-han-shu-he-send-te-zheng"></a>
...
### [递归使用 async fn](https://course.rs/advance/async/pain-points-and-workarounds.html#%E9%80%92%E5%BD%92%E4%BD%BF%E7%94%A8-async-fn) <a href="#di-gui-shi-yong-asyncfn" id="di-gui-shi-yong-asyncfn"></a>
...
### [在特征中使用 async](https://course.rs/advance/async/pain-points-and-workarounds.html#%E5%9C%A8%E7%89%B9%E5%BE%81%E4%B8%AD%E4%BD%BF%E7%94%A8-async) <a href="#zai-te-zheng-zhong-shi-yong-async" id="zai-te-zheng-zhong-shi-yong-async"></a>
...
## [一个实践项目: Web 服务器](https://course.rs/advance/async/web-server.html#%E4%B8%80%E4%B8%AA%E5%AE%9E%E8%B7%B5%E9%A1%B9%E7%9B%AE-web-%E6%9C%8D%E5%8A%A1%E5%99%A8) <a href="#yi-ge-shi-jian-xiang-mu-web-fu-wu-qi" id="yi-ge-shi-jian-xiang-mu-web-fu-wu-qi"></a>

知识学得再多，不实际应用也是纸上谈兵，不是忘掉就是废掉，对于技术学习尤为如此。在之前章节中，我们已经学习了 `Async Rust` 的方方面面，现在来将这些知识融会贯通，最终实现一个并发 Web 服务器。

### [多线程版本的 Web 服务器](https://course.rs/advance/async/web-server.html#%E5%A4%9A%E7%BA%BF%E7%A8%8B%E7%89%88%E6%9C%AC%E7%9A%84-web-%E6%9C%8D%E5%8A%A1%E5%99%A8) <a href="#duo-xian-cheng-ban-ben-de-web-fu-wu-qi" id="duo-xian-cheng-ban-ben-de-web-fu-wu-qi"></a>
...
### [运行异步代码](https://course.rs/advance/async/web-server.html#%E8%BF%90%E8%A1%8C%E5%BC%82%E6%AD%A5%E4%BB%A3%E7%A0%81) <a href="#yun-hang-yi-bu-dai-ma" id="yun-hang-yi-bu-dai-ma"></a>
...
[**使用 `async-std` 作为异步运行时**](https://course.rs/advance/async/web-server.html#%E4%BD%BF%E7%94%A8-async-std-%E4%BD%9C%E4%B8%BA%E5%BC%82%E6%AD%A5%E8%BF%90%E8%A1%8C%E6%97%B6)
...
### [并发地处理连接](https://course.rs/advance/async/web-server.html#%E5%B9%B6%E5%8F%91%E5%9C%B0%E5%A4%84%E7%90%86%E8%BF%9E%E6%8E%A5) <a href="#bing-fa-di-chu-li-lian-jie" id="bing-fa-di-chu-li-lian-jie"></a>
...
### [使用多线程并行处理请求](https://course.rs/advance/async/web-server.html#%E4%BD%BF%E7%94%A8%E5%A4%9A%E7%BA%BF%E7%A8%8B%E5%B9%B6%E8%A1%8C%E5%A4%84%E7%90%86%E8%AF%B7%E6%B1%82) <a href="#shi-yong-duo-xian-cheng-bing-hang-chu-li-qing-qiu" id="shi-yong-duo-xian-cheng-bing-hang-chu-li-qing-qiu"></a>
...
### [测试 `handle_connection` 函数](https://course.rs/advance/async/web-server.html#%E6%B5%8B%E8%AF%95-handle\_connection-%E5%87%BD%E6%95%B0) <a href="#ce-shi-handleconnection-han-shu" id="ce-shi-handleconnection-han-shu"></a>
