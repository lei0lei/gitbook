...
### [宏和函数的区别](https://course.rs/advance/macro.html#%E5%AE%8F%E5%92%8C%E5%87%BD%E6%95%B0%E7%9A%84%E5%8C%BA%E5%88%AB) <a href="#hong-he-han-shu-de-qu-bie" id="hong-he-han-shu-de-qu-bie"></a>

宏和函数的区别并不少，而且对于宏擅长的领域，函数其实是有些无能为力的。

[**元编程**](https://course.rs/advance/macro.html#%E5%85%83%E7%BC%96%E7%A8%8B)
...
[**可变参数**](https://course.rs/advance/macro.html#%E5%8F%AF%E5%8F%98%E5%8F%82%E6%95%B0)
...
[**宏展开**](https://course.rs/advance/macro.html#%E5%AE%8F%E5%B1%95%E5%BC%80)

由于宏会被展开成其它代码，且这个展开过程是发生在编译器对代码进行解释之前。因此，宏可以为指定的类型实现某个特征：先将宏展开成实现特征的代码后，再被编译。

而函数就做不到这一点，因为它直到运行时才能被调用，而特征需要在编译期被实现。

[**宏的缺点**](https://course.rs/advance/macro.html#%E5%AE%8F%E7%9A%84%E7%BC%BA%E7%82%B9)

相对函数来说，由于宏是基于代码再展开成代码，因此实现相比函数来说会更加复杂，再加上宏的语法更为复杂，最终导致定义宏的代码相当地难读，也难以理解和维护。

### [声明式宏 `macro_rules!`](https://course.rs/advance/macro.html#%E5%A3%B0%E6%98%8E%E5%BC%8F%E5%AE%8F-macro\_rules) <a href="#sheng-ming-shi-hong-macrorules" id="sheng-ming-shi-hong-macrorules"></a>
...
[**简化版的 vec!**](https://course.rs/advance/macro.html#%E7%AE%80%E5%8C%96%E7%89%88%E7%9A%84-vec)
...
[**模式解析**](https://course.rs/advance/macro.html#%E6%A8%A1%E5%BC%8F%E8%A7%A3%E6%9E%90)
...
[**未来将被替代的 `macro_rules`**](https://course.rs/advance/macro.html#%E6%9C%AA%E6%9D%A5%E5%B0%86%E8%A2%AB%E6%9B%BF%E4%BB%A3%E7%9A%84-macro\_rules)
...
### [用过程宏为属性标记生成代码](https://course.rs/advance/macro.html#%E7%94%A8%E8%BF%87%E7%A8%8B%E5%AE%8F%E4%B8%BA%E5%B1%9E%E6%80%A7%E6%A0%87%E8%AE%B0%E7%94%9F%E6%88%90%E4%BB%A3%E7%A0%81) <a href="#yong-guo-cheng-hong-wei-shu-xing-biao-ji-sheng-cheng-dai-ma" id="yong-guo-cheng-hong-wei-shu-xing-biao-ji-sheng-cheng-dai-ma"></a>
...
> 事实上，根据[这个说法](https://www.reddit.com/r/rust/comments/t1oa1e/what\_are\_the\_complex\_technical\_reasons\_why/)，过程宏放入独立包的原因在于它必须先被编译后才能使用，如果过程宏和使用它的代码在一个包，就必须先单独对过程宏的代码进行编译，然后再对我们的代码进行编译，但悲剧的是 Rust 的编译单元是包，因此你无法做到这一点。
...
### [自定义 `derive` 过程宏](https://course.rs/advance/macro.html#%E8%87%AA%E5%AE%9A%E4%B9%89-derive-%E8%BF%87%E7%A8%8B%E5%AE%8F) <a href="#zi-ding-yi-derive-guo-cheng-hong" id="zi-ding-yi-derive-guo-cheng-hong"></a>
...
[**定义过程宏**](https://course.rs/advance/macro.html#%E5%AE%9A%E4%B9%89%E8%BF%87%E7%A8%8B%E5%AE%8F)
...
从展开的代码也能看出derive宏的特性，struct Sunfei; 和 struct Sunface; 都被保留了，也就是说最后 impl\_hello\_macro() 返回的token被加到结构体后面，这和类属性宏可以修改输入 的token是不一样的，input的token并不能被修改
...
### [类属性宏(Attribute-like macros)](https://course.rs/advance/macro.html#%E7%B1%BB%E5%B1%9E%E6%80%A7%E5%AE%8Fattribute-like-macros) <a href="#lei-shu-xing-hong-attributelikemacros" id="lei-shu-xing-hong-attributelikemacros"></a>
...
### [类函数宏(Function-like macros)](https://course.rs/advance/macro.html#%E7%B1%BB%E5%87%BD%E6%95%B0%E5%AE%8Ffunction-like-macros) <a href="#lei-han-shu-hong-functionlikemacros" id="lei-han-shu-hong-functionlikemacros"></a>
...
### [补充学习资料](https://course.rs/advance/macro.html#%E8%A1%A5%E5%85%85%E5%AD%A6%E4%B9%A0%E8%B5%84%E6%96%99) <a href="#bu-chong-xue-xi-zi-liao" id="bu-chong-xue-xi-zi-liao"></a>
...
4. [Structuring, testing and debugging procedural macro crates](https://www.reddit.com/r/rust/comments/rjumsg/any\_good\_resources\_for\_learning\_rust\_macros/)，从测试、debug、结构化的角度来编写过程宏
5. [blog.turbo.fish](https://blog.turbo.fish/)，里面的过程宏系列文章值得一读
6. [Rust 宏小册中文版](https://zjp-cn.github.io/tlborm/)，非常详细的解释了宏各种知识

### [总结](https://course.rs/advance/macro.html#%E6%80%BB%E7%BB%93) <a href="#zong-jie" id="zong-jie"></a>
