...
![../../\_images/add\_script\_button.webp](https://docs.godotengine.org/zh-cn/4.x/_images/add_script_button.webp)
...
![../../\_images/attach\_node\_window.webp](https://docs.godotengine.org/zh-cn/4.x/_images/attach_node_window.webp)
...
![../../\_images/export\_variable.webp](https://docs.godotengine.org/zh-cn/4.x/_images/export_variable.webp)
...
![../../\_images/input-mapping-add-action.webp](https://docs.godotengine.org/zh-cn/4.x/_images/input-mapping-add-action.webp)

我们需要为这个操作分配一个按键。单击右侧的“+”图标，打开事件管理器窗口。

![../../\_images/input-mapping-add-key.webp](https://docs.godotengine.org/zh-cn/4.x/_images/input-mapping-add-key.webp)

会自动选中“正在监听输入...”区域。按下键盘上的“右方向”键，菜单应该像这样。

![../../\_images/input-mapping-event-configuration.webp](https://docs.godotengine.org/zh-cn/4.x/_images/input-mapping-event-configuration.webp)
...
![../../\_images/input-mapping-completed.webp](https://docs.godotengine.org/zh-cn/4.x/_images/input-mapping-completed.webp)
...
### 选择动画[](https://docs.godotengine.org/zh-cn/4.x/getting_started/first_2d_game/03.coding_the_player.html#choosing-animations)
...
### 准备碰撞[](https://docs.godotengine.org/zh-cn/4.x/getting_started/first_2d_game/03.coding_the_player.html#preparing-for-collisions)
...
![../../\_images/player\_signals.webp](https://docs.godotengine.org/zh-cn/4.x/_images/player_signals.webp)
...
![../../\_images/player\_signal\_connection.webp](https://docs.godotengine.org/zh-cn/4.x/_images/player_signal_connection.webp)
