...
## [使用 if 来做分支控制](https://course.rs/basic/flow-control.html#%E4%BD%BF%E7%94%A8-if-%E6%9D%A5%E5%81%9A%E5%88%86%E6%94%AF%E6%8E%A7%E5%88%B6) <a href="#shi-yong-if-lai-zuo-fen-zhi-kong-zhi" id="shi-yong-if-lai-zuo-fen-zhi-kong-zhi"></a>
...
## [使用 else if 来处理多重条件](https://course.rs/basic/flow-control.html#%E4%BD%BF%E7%94%A8-else-if-%E6%9D%A5%E5%A4%84%E7%90%86%E5%A4%9A%E9%87%8D%E6%9D%A1%E4%BB%B6) <a href="#shi-yong-elseif-lai-chu-li-duo-chong-tiao-jian" id="shi-yong-elseif-lai-chu-li-duo-chong-tiao-jian"></a>
...
## [循环控制](https://course.rs/basic/flow-control.html#%E5%BE%AA%E7%8E%AF%E6%8E%A7%E5%88%B6) <a href="#xun-huan-kong-zhi" id="xun-huan-kong-zhi"></a>

循环无处不在，上到数钱，下到数年，你能想象的很多场景都存在循环，因此它也是流程控制中最重要的组成部分之一。

在 Rust 语言中有三种循环方式：`for`、`while` 和 `loop`，其中 `for` 循环是 Rust 循环王冠上的明珠。

### [for 循环](https://course.rs/basic/flow-control.html#for-%E5%BE%AA%E7%8E%AF) <a href="#for-xun-huan" id="for-xun-huan"></a>
...
### [`continue`](https://course.rs/basic/flow-control.html#continue) <a href="#continue" id="continue"></a>
...
### [`break`](https://course.rs/basic/flow-control.html#break) <a href="#break" id="break"></a>
...
### [while 循环](https://course.rs/basic/flow-control.html#while-%E5%BE%AA%E7%8E%AF) <a href="#while-xun-huan" id="while-xun-huan"></a>
...
### [loop 循环](https://course.rs/basic/flow-control.html#loop-%E5%BE%AA%E7%8E%AF) <a href="#loop-xun-huan" id="loop-xun-huan"></a>
