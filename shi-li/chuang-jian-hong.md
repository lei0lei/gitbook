...
## [使用 `macro_rules!` 来创建宏](https://rustwiki.org/zh-CN/rust-by-example/macros.html#%E4%BD%BF%E7%94%A8-macro\_rules-%E6%9D%A5%E5%88%9B%E5%BB%BA%E5%AE%8F) <a href="#shi-yong-macrorules-lai-chuang-jian-hong" id="shi-yong-macrorules-lai-chuang-jian-hong"></a>
...
这个例子非常简单，但是已经有很多利用宏开发的复杂接口了，比如 [`lazy_static`](https://crates.io/crates/lazy\_static) 和 [`clap`](https://crates.io/crates/clap)。\
