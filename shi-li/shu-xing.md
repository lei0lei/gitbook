...
* 禁用 [lint](https://en.wikipedia.org/wiki/Lint\_\(software\)) （警告）
...
## [死代码 `dead_code`](https://rustwiki.org/zh-CN/rust-by-example/attribute/unused.html#%E6%AD%BB%E4%BB%A3%E7%A0%81-dead\_code)

编译器提供了 `dead_code`（死代码，无效代码）[_lint_](https://en.wikipedia.org/wiki/Lint\_\(software\))，这会对未使用的函数产生警告。可以用一个**属性**来禁用这个 lint。
